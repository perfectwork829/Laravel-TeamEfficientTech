        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <?php echo e(trans('global.create')); ?> <?php echo e(trans('cruds.timeEntry.title_singular')); ?>

                </div>
                <div class="panel-body">
                    <form method="POST" action="<?php echo e(route("admin.time-entries.store")); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('start_time') ? 'has-error' : ''); ?>">
                            ...
                            <input class="form-control datetime" type="text" name="start_time" id="start_time" value="<?php echo e(old('start_time')); ?>" required>
                        ...
                        <div class="form-group <?php echo e($errors->has('end_time') ? 'has-error' : ''); ?>">
                            ...
                            <input class="form-control datetime" type="text" name="end_time" id="end_time" value="<?php echo e(old('end_time')); ?>" required>
                        ...
                        <div class="form-group <?php echo e($errors->has('notes') ? 'has-error' : ''); ?>">
                            ...
                            <textarea class="form-control" name="notes" id="notes" required><?php echo e(old('notes')); ?></textarea>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teameffi/public_html/app.teamefficienttech.com/resources/views/admin/timeEntries/create.blade.php ENDPATH**/ ?>