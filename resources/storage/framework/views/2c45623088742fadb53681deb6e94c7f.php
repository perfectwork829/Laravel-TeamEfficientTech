        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <?php echo e(trans('global.edit')); ?> <?php echo e(trans('cruds.expense.title_singular')); ?>

                </div>
                <div class="panel-body">
                    <form method="POST" action="<?php echo e(route("admin.expenses.update", [$expense->id])); ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group <?php echo e($errors->has('expense_category') ? 'has-error' : ''); ?>">
                            ...
                            <select class="form-control select2" name="expense_category_id" id="expense_category_id">
                                <?php $__currentLoopData = $expense_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($id); ?>" <?php echo e((old('expense_category_id') ? old('expense_category_id') : $expense->expense_category->id ?? '') == $id ? 'selected' : ''); ?>><?php echo e($entry); ?></option>
                        ...
                        <div class="form-group <?php echo e($errors->has('entry_date') ? 'has-error' : ''); ?>">
                            ...
                            <input class="form-control date" type="text" name="entry_date" id="entry_date" value="<?php echo e(old('entry_date', $expense->entry_date)); ?>" required>
                        ...
                        <div class="form-group <?php echo e($errors->has('amount') ? 'has-error' : ''); ?>">
                            ...
                            <input class="form-control" type="number" name="amount" id="amount" value="<?php echo e(old('amount', $expense->amount)); ?>" step="0.01" required>
                        ...
                        <div class="form-group <?php echo e($errors->has('mileage') ? 'has-error' : ''); ?>">
                            ...
                            <input class="form-control" type="number" name="mileage" id="mileage" value="<?php echo e(old('mileage', $expense->mileage)); ?>" step="1">
                        ...
                        <div class="form-group <?php echo e($errors->has('description') ? 'has-error' : ''); ?>">
                            ...
                            <input class="form-control" type="text" name="description" id="description" value="<?php echo e(old('description', $expense->description)); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teameffi/public_html/app.teamefficienttech.com/resources/views/admin/expenses/edit.blade.php ENDPATH**/ ?>