        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-IncomeCategory">
                        <thead>
                            <tr>
                                <th width="10">
...
<?php endif; ?>
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "<?php echo e(route('admin.income-categories.index')); ?>",
    columns: [
...
{ data: 'actions', name: '<?php echo e(trans('global.actions')); ?>' }
  ...
  let table = $('.datatable-IncomeCategory').DataTable(dtOverrideGlobals);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teameffi/public_html/app.teamefficienttech.com/resources/views/admin/incomeCategories/index.blade.php ENDPATH**/ ?>