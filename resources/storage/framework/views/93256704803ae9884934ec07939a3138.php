        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="POST" action="<?php echo e(route("admin.tasks.update", [$task->id])); ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group <?php echo e($errors->has('starttime') ? 'has-error' : ''); ?>">
                            ...
                            <input class="form-control datetime" type="text" name="starttime" id="starttime" value="<?php echo e(old('starttime', $task->starttime)); ?>" required>
                        ...
                        <div class="form-group <?php echo e($errors->has('endtime') ? 'has-error' : ''); ?>">
                            ...
                            <input class="form-control datetime" type="text" name="endtime" id="endtime" value="<?php echo e(old('endtime', $task->endtime)); ?>" required>
                        ...
                        <div class="form-group <?php echo e($errors->has('description') ? 'has-error' : ''); ?>">
                            ...
                            <textarea class="form-control" name="description" id="description"><?php echo e(old('description', $task->description)); ?></textarea>
                        ...
                        <div class="form-group <?php echo e($errors->has('assigned_to') ? 'has-error' : ''); ?>">
                            ...
                            <select class="form-control select2" name="assigned_to_id" id="assigned_to_id" required>
                                <?php $__currentLoopData = $assigned_tos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($id); ?>" <?php echo e((old('assigned_to_id') ? old('assigned_to_id') : $task->assigned_to->id ?? '') == $id ? 'selected' : ''); ?>><?php echo e($entry); ?></option>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teameffi/public_html/app.teamefficienttech.com/resources/views/admin/tasks/edit.blade.php ENDPATH**/ ?>