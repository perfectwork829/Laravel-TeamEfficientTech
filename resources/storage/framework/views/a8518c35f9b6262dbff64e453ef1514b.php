...
<div class="content">
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('time_entry_create')): ?>
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="<?php echo e(route('admin.time-entries.create')); ?>">
                    <?php echo e(trans('global.add')); ?> <?php echo e(trans('cruds.timeEntry.title_singular')); ?>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <?php echo e(trans('cruds.timeEntry.title_singular')); ?> <?php echo e(trans('global.list')); ?>
...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('time_entry_delete')): ?>
  ...
  let deleteButton = {
    ...
    url: "<?php echo e(route('admin.time-entries.massDestroy')); ?>",
...
<?php endif; ?>
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "<?php echo e(route('admin.time-entries.index')); ?>",
    columns: [
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teameffi/public_html/app.teamefficienttech.com/resources/views/admin/timeEntries/index.blade.php ENDPATH**/ ?>