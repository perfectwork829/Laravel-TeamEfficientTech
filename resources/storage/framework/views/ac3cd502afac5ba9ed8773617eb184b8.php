                    ...
                    <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Expense">
                        <thead>
                            <tr>
                                ...
                                <th>
                                    <?php echo e(trans('cruds.expense.fields.mileage')); ?>
...
<?php endif; ?>
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "<?php echo e(route('admin.expenses.index')); ?>",
    columns: [
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teameffi/public_html/app.teamefficienttech.com/resources/views/admin/expenses/index.blade.php ENDPATH**/ ?>