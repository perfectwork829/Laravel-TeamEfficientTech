                    ...
                    <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Team">
                        <thead>
                            <tr>
                                ...
                                <th>
                                    <?php echo e(trans('cruds.team.fields.id')); ?>
                                ...
                                <th>
                                    <?php echo e(trans('cruds.team.fields.owner')); ?>
...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('team_delete')): ?>
  ...
  let deleteButton = {
    ...
    url: "<?php echo e(route('admin.teams.massDestroy')); ?>",
...
<?php endif; ?>
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "<?php echo e(route('admin.teams.index')); ?>",
    columns: [
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teameffi/public_html/app.teamefficienttech.com/resources/views/admin/teams/index.blade.php ENDPATH**/ ?>