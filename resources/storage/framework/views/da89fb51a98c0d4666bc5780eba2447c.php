                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-userCheckIns">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $checkIns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $checkIn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr data-entry-id="<?php echo e($checkIn->id); ?>">
                                        <td>
                                        ...
                                        <td>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('check_in_show')): ?>
                                                <a class="btn btn-xs btn-primary" href="<?php echo e(route('admin.check-ins.show', $checkIn->id)); ?>">
                                                    <?php echo e(trans('global.view')); ?>

                                                </a>
                                            <?php endif; ?>

                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('check_in_edit')): ?>
                                                <a class="btn btn-xs btn-info" href="<?php echo e(route('admin.check-ins.edit', $checkIn->id)); ?>">
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('check_in_delete')): ?>
                                                <form action="<?php echo e(route('admin.check-ins.destroy', $checkIn->id)); ?>" method="POST" onsubmit="return confirm('<?php echo e(trans('global.areYouSure')); ?>');" style="display: inline-block;">
...
<?php $__env->stopSection(); ?><?php /**PATH /home/teameffi/public_html/app.teamefficienttech.com/resources/views/admin/users/relationships/userCheckIns.blade.php ENDPATH**/ ?>