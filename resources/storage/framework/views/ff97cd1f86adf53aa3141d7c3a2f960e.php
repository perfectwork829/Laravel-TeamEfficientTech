            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <?php echo e(trans('global.edit')); ?> <?php echo e(trans('cruds.checkIn.title_singular')); ?>

                    </div>
                    <div class="panel-body">
                        <form method="POST" action="<?php echo e(route("admin.check-ins.update", [$checkIn->id])); ?>" enctype="multipart/form-data">
                            ...
                            <div class="form-group <?php echo e($errors->has('user') ? 'has-error' : ''); ?>">
                                ...
                                <select class="form-control select2" name="user_id" id="user_id" required>
                                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($id); ?>" <?php echo e((old('user_id') ? old('user_id') : $checkIn->user->id ?? '') == $id ? 'selected' : ''); ?>><?php echo e($entry); ?></option>
                            ...
                            <div class="form-group <?php echo e($errors->has('type') ? 'has-error' : ''); ?>">
                                ...
                                <select class="form-control select2" name="type_id" id="type_id">
                                    <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($id); ?>" <?php echo e((old('type_id') ? old('type_id') : $checkIn->type->id ?? '') == $id ? 'selected' : ''); ?>><?php echo e($entry); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            ...
                            <div class="form-group <?php echo e($errors->has('project') ? 'has-error' : ''); ?>">
                                ...
                                <select class="form-control select2" name="project_id" id="project_id" required>
                                    <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($id); ?>" <?php echo e((old('project_id') ? old('project_id') : $checkIn->project->id ?? '') == $id ? 'selected' : ''); ?>><?php echo e($entry); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            ...
                            <div class="form-group <?php echo e($errors->has('check_in') ? 'has-error' : ''); ?>">
                                ...
                                <input class                            ="form-control datetime <?php echo e($errors->has('check_in') ? 'is-invalid' : ''); ?>" type="text" name="check_in" id="check_in" value="<?php echo e(old('check_in', optional($checkIn->check_in)->format('Y-m-d H:i:s'))); ?>">
                            <?php if($errors->has('check_in')): ?>
                                <span class="help-block" role="alert"><?php echo e($errors->first('check_in')); ?></span>
                            <?php endif; ?>
                            <span class="help-block"><?php echo e(trans('cruds.checkIn.fields.check_in_helper')); ?></span>
                        </div>
                        <div class="form-group <?php echo e($errors->has('check_out') ? 'has-error' : ''); ?>">
                            ...
                            <input class="form-control datetime <?php echo e($errors->has('check_out') ? 'is-invalid' : ''); ?>" type="text" name="check_out" id="check_out" value="<?php echo e(old('check_out', optional($checkIn->check_out)->format('Y-m-d H:i:s'))); ?>">
                        ...
                        <div class="form-group <?php echo e($errors->has('work_type') ? 'has-error' : ''); ?>">
                            ...
                            <select class="form-control select2" name="work_type_id" id="work_type_id">
                                <?php $__currentLoopData = $workTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($id); ?>" <?php echo e((old('work_type_id') ? old('work_type_id') : $checkIn->work_type->id ?? '') == $id ? 'selected' : ''); ?>><?php echo e($entry); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        ...
                        <div class="form-group <?php echo e($errors->has('notes') ? 'has-error' : ''); ?>">
                            ...
                            <textarea class="form-control <?php echo e($errors->has('notes') ? 'is-invalid' : ''); ?>" name="notes" id="notes"><?php echo e(old('notes', $checkIn->notes)); ?></textarea>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/teameffi/public_html/app.teamefficienttech.com/resources/views/admin/checkIns/edit.blade.php ENDPATH**/ ?>