                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.time-entries.update", [$timeEntry->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('start_time') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control datetime" type="text" name="start_time" id="start_time" value="{{ old('start_time', $timeEntry->start_time) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('end_time') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control datetime" type="text" name="end_time" id="end_time" value="{{ old('end_time', $timeEntry->end_time) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('notes') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="notes" id="notes" required>{{ old('notes', $timeEntry->notes) }}</textarea>
                            @if($errors->has('notes'))
