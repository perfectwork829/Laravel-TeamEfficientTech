                                    ...
                                    <tr data-entry-id="{{ $userNotification->id }}">
                                        ...
                                        <td>
                                            @can('user_notification_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('admin.user-notifications.show', $userNotification->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('user_notification_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('admin.user-notifications.edit', $userNotification->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan
