...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    Route::post('/log-location', [LocationController::class, 'logLocation'])->name('log-location');
    ...
    // Check In Types
    Route::delete('check-in-types/destroy', 'CheckInTypesController@massDestroy')->name('check-in-types.massDestroy');
    Route::resource('check-in-types', 'CheckInTypesController');

    // User Dashboard
    Route::delete('user-dashboards/destroy', 'UserDashboardController@massDestroy')->name('user-dashboards.massDestroy');
    Route::resource('user-dashboards', 'UserDashboardController');
    ...
    Route::get('tasks/view/daily_task', 'TaskController@dailyTask')->name('tasks.dailyTask');
    Route::any('tasks/view/paycheck', 'TaskController@payCheck')->name('tasks.payCheck');

    Route::get('tasks/view/getTasks', 'TaskController@getTasks')->name('tasks.getTasks');
    Route::get('tasks/view/getTimeWorkType', 'TaskController@getComboData')->name('tasks.comboData');    
    //Route::get('tasks/view/createTask', 'TaskController@createTask')->name('tasks.createTask');
    Route::post('tasks/{id}/updateTask', 'TaskController@updateTask')->name('tasks.updateTask');  //update the specific task
    Route::post('tasks/createTask', 'TaskController@createTask')->name('tasks.createTask');  //save the new task
    Route::post('tasks/{id}/delTask', 'TaskController@delTask')->name('tasks.delTask');  //delete the specific task
